        ...
        # Solicitud para crear un nuevo objeto
            ...
            try:
                ...
                if serializer.is_valid():
                    ...
                    user = Usuario.objects.get(identificacion=serializer.data['identificacion'])
                    user.set_password(serializer.data['contraseña'])  # Encriptar la contraseña
                    user.save()
...
def inicio_sesion(request):
    try:        
        user = Usuario.objects.get(identificacion=request.data['identificacion']) # Obtener el usuario por documento
